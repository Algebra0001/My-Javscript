...
// Your task: 
// Write a function solution(N) that given a positive a integer N, returns the length of its longest binarygap. The function should return 0 if n N does not have any binary gap..
function solution(N){
